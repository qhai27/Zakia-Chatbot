...
def get_unanswered_questions():
    """
    Get unanswered questions (low confidence responses)
    Query params:
    ...
    try:
        ...
        print(f"❌ Unanswered questions error: {e}")
        return jsonify({
            "success": True,
...
def update_unanswered_question(question_id):
    """
    ...
    try:
        ...
        if status not in ['reviewed', 'answered']:
            return jsonify({
                "success": False,
